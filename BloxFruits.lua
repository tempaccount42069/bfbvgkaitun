...
spawn(function()
	print("|KITKAT DEBUG| Anti Stranger Join")
	while wait() do
		pcall(function()
			if _25msShared.AntiStranger then
				for L_222_forvar0, L_223_forvar1 in pairs(game:GetService("Players"):GetChildren()) do
					if L_223_forvar1.Data.Level.Value >= 2601 or L_223_forvar1.Data.Level.Value > 20000 then
						game.Players.LocalPlayer:Kick("[KitKat Hub] Admin Detected.")
						print("|KITKAT DEBUG| Detected Stranger, Hopping Server...")
						Hop()
					end
				end
			end
	...
	task.spawn(function()
		...
		if setfflag then
			task.spawn(function()
				...
				print("|KITKAT DEBUG| Anti Ban Loaded in: " .. os.clock() - L_228_)
			end)
		else
			print("|KITKAT DEBUG| Anti Ban not support this Executor!")
		end
	end)
end)
L_35_.Setting:Line()
...
L_35_.Info:Button("Discord", function()
	setclipboard("https://discord.gg/RFnU82Jxgn")
end)
L_35_.Info:Button("My YouTube", function()
...
L_35_.Info:Button("Listen to Lofi Music", function()
	...
	L_553_.SoundId = "rbxassetid://1848354536"
	L_553_.Volume = 1;
...
task.delay(2, function()
	if hookfunction and not islclosure(hookfunction) then
		print("|KITKAT DEBUG| Remove Effects")
...
print("|KITKAT DEBUG| Done loaded Kitkat in: " .. os.clock() - L_1_)
